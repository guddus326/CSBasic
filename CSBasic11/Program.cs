...
namespace CSBasic11
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            {
                Console.WriteLine(item.no + "\t" +item.hour+"\t"+
                    item.day + "\t" + item.temp + "\t" +
                    item.wdKor + "\t" + item.wfKor + "\t" +
            ...
            List<Product> products = new List<Product>()
            {
                ...
                new Product(){Name="감자", Price=1530},
                new Product(){Name="사과", Price=1540},
                new Product(){Name="옥수수", Price=500},
                new Product(){Name="자두", Price=400},
                new Product(){Name="토마토", Price=15300},
